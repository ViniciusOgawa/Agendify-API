...
contactsRoutes.post("", ensureEmailExists, ensureDataIsValid(contactSchemaRequest), createContactController)
contactsRoutes.delete("/:id", ensureIsOwnerMiddleware, deleteContactController)
contactsRoutes.patch("/:id", ensureIsOwnerMiddleware, ensureDataIsValid(contactSchemaUpdate), updateContactController)
